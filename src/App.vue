...
const lingprog = ref('');
const biografia = ref('');
const confirmarUsuario = ref(false);
const senhaErro = ref('');
...
<template>
  <div class="div1">
    <form @submit.prevent="confirmarUsuario = confirmasenha()" class="formulario">
      <div class="menu">
        ...
        <p>Biografia: </p><textarea v-model="biografia" cols="20" rows="5"></textarea>
